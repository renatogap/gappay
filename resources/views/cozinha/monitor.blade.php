                    ...
                    <div class="card bg-light mb-3" style="text-shadow: 5px 5px 5px rbga(0,0,0,0.5); box-shadow: 5px 5px 5px rgba(0,0,0,0.5);">
                        ...
                        <div class="card-body pl-3 pr-3 pt-1" style="background: white;">
                            ...
                            <?php
                                ...
                                $itens = \Illuminate\Support\Facades\DB::table('pedido_item as pi')
                        ...
                        <div class="card-footer">
                            ...
                            <span class="float-right"><i class="material-icons icone">person</i> {{ \GapPay\Seguranca\Models\Entity\Usuario::find($p->fk_usuario)->nome }}</span>
                        </div>
                    </div>
                </div>
            </div>
