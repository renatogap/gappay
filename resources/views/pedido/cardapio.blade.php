...
<div id="grid-cardapio">
    ...
    <a v-if="Object.keys(itensSelecionados).length > 0" href="{{ url('pedido/confirmar-pedido') }}" class="btn btn-primary btn-lg pull-right btn-circulo btn-flutuante" title="Finalizar pedido">
    ...
    createApp({
        setup() {
            ...
            const carregarCardapio = async (id_tipo_cardapio) => {
                ...
                let URL = '{{ url("pedido/cardapio/show") }}/' + id_tipo_cardapio;
            ...
            const adicionarItem = (item) => {
                ...
                fetch('{{ url("pedido/cardapio/add-pedido-cliente") }}', {
                    method: 'POST',
                    headers: {
            ...
            const removerItem = (item) => {
                ...
                fetch('{{ url("pedido/cardapio/remove-item-pedido-cliente") }}', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
