    ...
    <form id="form" class="form-horizontal container">
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="text" name="nome" required value="{{$oAcao->nome}}" placeholder="sugestão: modulo/controlador/acao" class="form-control">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">Descrição</label>
                <div class="col-sm-6">
                    <input type="text" name="descricao" value="{{$oAcao->descricao}}" class="form-control">
                </div>
            </div>
            <div class="form-group">
            ...
            <div id="div_amigavel" class="form-group" style="display: {{$oAcao->destaque ? 'block' : 'none'}}">
                <label class="col-sm-2 control-label">Nome amigável *</label>
                <div class="col-sm-3">
                    <input type="text" name="nome_amigavel" value="{{$oAcao->nome_amigavel}}" placeholder="Ex: Cadastrar usuário" class="form-control">
                </div>
            </div>
        </fieldset>
        <fieldset>
