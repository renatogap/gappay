...
<body>
    <nav class="navbar navbar-expand-md navbar-dark">
        <a class="navbar-brand">
            <i class="material-icons icone d-none d-md-inline" style="font-size: 1.5em !important;">home</i> 
            <b class="d-block d-md-inline text-center text-md-left w-100">{{ config('policia.nome') }}</b>
        </a>
    </nav>
