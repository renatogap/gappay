...
<div class="mt-3 pl-3 pr-3">
    <h3><i class="glyphicon glyphicon-chevron-right"></i> Bem-vindo ao Sistema <b>{{config('policia.nome')}}</b></h3>
    <div class="text-center mt-5">
        <!--<img class="logo" src="{{ config('policia.logo') }}" alt="">-->

        <div class="row">
            @if(isset($menu))
                @foreach($menu as $raiz)
                    <?php $url = url($raiz->acao ?? '#'); ?>
            ...
            <div class="col-4 col-md-4 mb-5" style="margin: 0 auto;">
                    <a href="{{url('seguranca/usuario/logout')}}">
                        <span class="material-icons" style="font-size: 4em;">power_settings_new</span>
