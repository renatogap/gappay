...
<form id="form" action="{{ route('usuario.update', ['usuario' => $usuario->id]) }}" method="post" class="form-horizontal" onsubmit="oController.salvar(event)">
    <div class="row">
        <div class="col-md-6">
...
@include('layouts.datatables-simples2', ['colunas' => ['cardapio'], 'id' => 'grid2'])
<script>
