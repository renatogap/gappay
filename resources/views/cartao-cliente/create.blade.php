    ...
    <div class="row">
        ...
        <div class="col-6 col-md-4">
            <div class="form-group">
                ...
                <input type="tel" name="telefone" class="form-control" value="{{ (old('telefone')) ?? '' }}" onkeyup="mTel(this)" required maxlength="14">
            </div>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="col-6 col-md-4">
            <div class="form-group">
                ...
                <input type="tel" name="valorCartao" id="valorCartao" readonly class="form-control" value="{{ (old('valorCartao')) ?? config('policia.valor_cartao') }}" required>
            </div>
        </div>
        <div class="col-6 col-md-4">
            <div class="form-group">
    ...
    <div class="row">
        <div class="col-12 col-md-8">
            <div class="form-group">
                ...
                <textarea name="observacao" class="form-control">Cadastro do cartão do aluno.</textarea>
            </div>
        </div>
    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h3>
                                ...
                                <div>Valor a ser Pago<br><b id="valorCreditoCliente" style="font-size: 1.5em;"></b> em <b id="tipoPagamento" style="font-size: 1.5em;"></b><br>confirma ?</div>
                            </h3>
                            <hr>
