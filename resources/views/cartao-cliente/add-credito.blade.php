...
@section('conteudo')
    <h4>
        ...
        <a href="{{url('cartao-cliente/leitor')}}" class="material-icons float-right"
            style="font-size: 1.3em; color: #333;">
            keyboard_backspace
        </a>
    </h4>
    <hr>
    ...
    <form id="formulario" method="post" action="{{ url('cartao-cliente/salvar-credito') }}">
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="form-group">
                    <div><label>Nome do aluno</label></div>
        ...
        <div class="row">
            <div class="col-md-4 col-6">
                <div class="form-group">
                    ...
                    <input class="form-control" disabled value="{{ $cartaoCliente->valor_atual }}">
                </div>
            </div>
        </div>
            ...
            <div class="col-md-4 col-6">
                <div class="form-group">
                    ...
                    <input type="number" name="valor" class="form-control" required value="{{ (old('valor') ?? '') }}"
                        onkeyup="changeValor(this.value)">
                </div>
            </div>
            <div class="col-md-4 col-6">
                <div class="form-group">
                    <div><label>Forma de Pagamento *</label></div>
                    <select name="tipo_pagamento" id="formaPagamento" class="form-control" required
                        onchange="changeTipoPagamento(this)">
                        <option value="">SELECIONE...</option>
                        @foreach($formaPagamento as $p)
                            <option {{ (old('tipo_pagamento')) == $p->id ? 'selected' : '' }} value="{{ $p->id }}">{{ $p->nome }}
                            </option>
                        @endforeach
                    </select>
                </div>
        ...
        <div class="row">
            <div class="form-group">
                <button type="button" id="btnSalvar" class="btn btn-parque ml-3 btn" data-toggle="modal"
                    data-target="#modal" disabled>Adicionar</button>
                <a href="{{url('cartao-cliente/leitor')}}" class="btn btn-secondary">Cancelar</a>
            </div>
        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center mb-3">
                        <div class="row">
                            <div class="col-md-12">
                                <h5>
                                    <span class="material-icons icone text-success"
                                        style="font-size: 3em !important;">contact_support</span>
                                    <div>Adicionar o valor de<br><b id="valorCreditoCliente" style="font-size: 1.5em;"></b>
                                        em <b id="tipoPagamento" style="font-size: 1.5em;"></b><br>Confirma ?</div>
                                </h5>
                                <hr>
